...
catalogue = "_w0-all_cmean-all_csigma-all_maxt-10-5_l-100_w0grain-5_cgrain-30"
x_name = "cmean"
y_name = "csigma"
z_name = "bond density"
col_no = 5 # t-2 mcs-3 magnetization-4 bonddens-5
W0_RANGE = np.linspace(0.51, 1.0, 5)
w0 = W0_RANGE[4]
title = "Rho Triangular W0:%.2f Averages:3 Grain:30x30 MaxT:10^5" % w0
